...
function notes()
{
	...
	if(usernamedisplay === 'ucuma'){
   // user has not logined in
   usernamedisplay = 'ucuma'
   $("#myModalflogin").modal('show');
...
function searchqry()
{
  ...
  document.getElementById("searchload").innerHTML = "Loading ..";

  var xmlhttp;
  var mani;
  var sendingnotes = document.getElementById("searchqry").value;

  if (sendingnotes == null || sendingnotes == "" || sendingnotes.length < 3) {
        
          document.getElementById("searchload").innerHTML = "meaningful search please..";
  ...
  else
  {
    ...
    xmlhttp.onreadystatechange=function()
      ...
      if (xmlhttp.readyState==4 && xmlhttp.status==200)
        ...
        document.getElementById("searchload").innerHTML = "Start your search";
