...
if dataofv:
	...
	nsql = """INSERT INTO *****(xx,xx,xx) VALUES(%s,%s,%s)"""
	cursor.execute(nsql,(yy,yy,yy))
	#creating a colum in notes table
	notesql = "ALTER TABLE ***** ADD "+username+" TEXT(65000)";
