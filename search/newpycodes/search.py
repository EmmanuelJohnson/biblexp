            ...
            for v in range(totsize):
                if con[v].isdigit():
                    ...
                    if res>-1:
                        ...
                        print '<li class="list-group-item" onclick="getvrforsearch('+str(dat[5])+')"> <a href="#"><h2>'+str(dat[1])+' '+str(dat[2])+':'+str(dat[3])+'</h2></a> <i>'+head+'</i> <br>'+tailver+'</li>'
            ...
            for wgo in range(len(mainwv)):
                if not mainwv[wgo].isdigit():
                    ...
                    if res1>-1:
                        ...
                        print '<li class="list-group-item" onclick="getvrforsearch('+str(dat[5])+')"> <a href="#"><h2>'+str(dat[1])+' '+str(dat[2])+':'+str(dat[3])+'</h2></a>'+mainwov+'</li>'
            ...
            for v in range(totsize):
                if con[v].isdigit():
                    ...
                    if res2>-1:
                        ...
                        print '<li class="list-group-item" onclick="getvrforsearch('+str(dat[5])+')"> <a href="#"><h2>'+str(dat[1])+' '+str(dat[2])+':'+str(dat[3])+'</h2></a> <i>'+head+'</i> <br>'+tailver+'<br>notes: '+notesary[notespos]+'</li>'
            ...
            for wgo in range(len(mainwv)):
                if not mainwv[wgo].isdigit():
                    ...
                    if res3>-1:
                        ...
                        print '<li class="list-group-item" onclick="getvrforsearch('+str(dat[5])+')"> <a href="#"><h2>'+str(dat[1])+' '+str(dat[2])+':'+str(dat[3])+'</h2></a> '+mainwov+'<br>notes: '+notesary[notespos]+'</li>'
